...
class Manager {
    ...
    initialiseEventListeners() {
        ...
        //Added for Cicada 3301
        document.getElementById("btn-open-lp").addEventListener("click", this.input.openImages.bind(this.input));
        document.getElementById("btn-load-lp").addEventListener("click", this.input.loadLP.bind(this.input)); 
