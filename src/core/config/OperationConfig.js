...
import LiberPrimus from "../operations/LiberPrimus.js";
import Gematria from "../operations/Gematria.js";
...
const OperationConfig = {
  "English Text To Gematria Sum": {
      description: "Sum each word into the appropriate Gematria sum.",
      run: LiberPrimus.gematriaSum, // a reference to the function that runs your operation
    ...
    "LP Text Conversion": {
        description: "Convert Text from Index/English/Gematria to Index/English/Gematria",
        run: LiberPrimus.runLPConvert, // a reference to the function that runs your operation
        inputType: "string", // the input type for your operation, see the next section for valid types
        outputType: "string", // the output type for your operation, see the next section for valid types
        highlight: true, // [optional] true if the operation does not change the position of bytes in the output (so that highlighting can be calculated)
        highlightReverse: true, // [optional] same as above but for the reverse of the operation (output to input highlighting)
        ...
        args: [ // A list of the arguments that the user will be presented with
            {
                ...
                value: LiberPrimus.LP_INPUT_FORMAT, // the default value of the argument
            },
            {
                name:"Input Space Type",
                type:"option",
                value: LiberPrimus.LP_SPACE_DELIMITER
            },
            {
                name: "Output Format",
                type: "option", // the argument data type, see the next section for valid types
                value: LiberPrimus.LP_OUTPUT_FORMAT // the default value of the argument
            },
            {
                name:"Out. Space Type",
                type:"option",
    ...
    "LP Apply Key": {
        description: "Running Key Cipher - If your output doesn't look right, make sure the input format of Apply Key matches the output format of Text Conversion",
        run: LiberPrimus.runApplyKey, // a reference to the function that runs your operation
        inputType: "string", // the input type for your operation, see the next section for valid types
        outputType: "string", // the output type for your operation, see the next section for valid types
        highlight: true, // [optional] true if the operation does not change the position of bytes in the output (so that highlighting can be calculated)
        highlightReverse: true, // [optional] same as above but for the reverse of the operation (output to input highlighting)
        ...
        args: [ // A list of the arguments that the user will be presented with
            ...
            },
            {
                name: "Operation",
                type: "option",
                value: LiberPrimus.LP_OPERATION
            },
            {
                name: "Key",
                type: "toggleString",
                value: "",
                toggleValues: LiberPrimus.LP_INPUT_FORMAT
            }
        ]
    },
    "Frequency Analysis": {
        description: "Display graph of letter frequencies",
        run: LiberPrimus.frequencyAnalysis, // a reference to the function that runs your operation
        inputType: "string", // the input type for your operation, see the next section for valid types
        outputType: "html", // the output type for your operation, see the next section for valid types
        highlight: true, // [optional] true if the operation does not change the position of bytes in the output (so that highlighting can be calculated)
        highlightReverse: true, // [optional] same as above but for the reverse of the operation (output to input highlighting)
        manualBake: false, // [optional] true if auto-bake should be disabled when this operation is added to the recipe
        args: [ // A list of the arguments that the user will be presented with
            {
                name: "Input Language",
                type: "option", // the argument data type, see the next section for valid types
                value: LiberPrimus.LP_FREQUENCY, // the default value of the argument
            }
        ]
    },
    "Runes": {
